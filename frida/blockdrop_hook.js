📦
471966 /blockdrop_hook_src.js
278952 /blockdrop_hook_src.js.map
✄
...
// blockdrop_hook_src.js
var require_blockdrop_hook_src = __commonJS({
  "blockdrop_hook_src.js"() {
    init_node_globals();
    ...
    frida_java_bridge_default.perform(function() {
      ...
      var SecurityCheck = frida_java_bridge_default.use(PKG + ".SecurityCheck");
      SecurityCheck.isDeviceRooted.implementation = function() {
        console.log("[root] SecurityCheck.isDeviceRooted() -> false");
        return false;
      };
      var Wallet = frida_java_bridge_default.use(PKG + ".Wallet");
